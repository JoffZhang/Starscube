...
!function (a, b) {
    ...
    var Ed = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/, Fd = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
        //Gd = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_")
        Gd = "一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_")
        , Hd = sd, Id = sd, Jd = {};
